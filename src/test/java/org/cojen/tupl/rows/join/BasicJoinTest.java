...
public class BasicJoinTest {
    ...
    public void crossJoin() throws Exception {
        ...
        var plan = """
            - nested loops join
              - first
                - full scan over primary key
                  table: org.cojen.tupl.rows.join.Department
                  key columns: +id
              - join
                - full scan over primary key
                  table: org.cojen.tupl.rows.join.Employee
                  key columns: +id
            """;
