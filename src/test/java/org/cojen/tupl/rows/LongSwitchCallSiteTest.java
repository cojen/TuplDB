 ...
 */
public class LongSwitchCallSiteTest {
    public static void main(String[] args) throws Exception {
        org.junit.runner.JUnitCore.main(LongSwitchCallSiteTest.class.getName());
    }
    ...
    public void noParamsDirect() throws Throwable {
        ...
        LongSwitchCallSite scs = makeNoParams();
    ...
    private static LongSwitchCallSite makeNoParams() {
        LongFunction<Object> generator = version -> {
        ...
        return new LongSwitchCallSite(MethodHandles.lookup(),
                                      MethodType.methodType(String.class, long.class), generator);
    }
    ...
    private static LongSwitchCallSite makeOneParam() {
        LongFunction<Object> generator = version -> {
