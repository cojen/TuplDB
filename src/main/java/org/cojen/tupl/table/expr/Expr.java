    ...
    permits BinaryOpExpr, ColumnExpr, ConstantExpr, ParamExpr, RelationExpr, VarExpr, WrappedExpr
{
    ...
    /**
     * Generates filter code for the SelectMappedExpr remap method. It performs eager
    ...
    /**
     * Returns true if the filtering code generated by this expression can throw a
     * RuntimeException which might be suppressed if the evaluation order was changed. This
     * implies that the expression performs short-circuit logic and that
     * canThrowRuntimeException returns true.
     */
