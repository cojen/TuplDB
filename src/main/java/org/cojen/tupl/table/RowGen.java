                                             ...
                                             String subPackage, String suffix)
    {
        ...
        if (rowType == null) {
            ...
            if (rowType.isSynthetic()) {
                // Assume it was generated by RowTypeMaker, so choose it's parent loader in
                // order for the new class to be generated into the same loader. This isn't
                // strictly required -- it just reduces the number of ClassLoader instances.
