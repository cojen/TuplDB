 ...
 * 
 *
 * @author Generated by PageAccessTransformer from TempFileManager.java
 */
/*P*/
final class _TempFileManager implements CauseCloseable, _Checkpointer.Shutdown {
     ...
     */
    _TempFileManager(File baseFile, FileFactory factory) throws IOException {
        mBaseFile = baseFile;
