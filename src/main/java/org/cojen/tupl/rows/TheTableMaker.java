 ...
 */
public class TheTableMaker extends TableMaker {
     ...
     */
    TheTableMaker(Class<?> type, RowGen rowGen,
                  boolean supportsIndexLock, RowStore store, long tableId)
    {
        this(type, rowGen, rowGen, null, supportsIndexLock, store, tableId);
    }
     ...
     * @param tableId primary table index id
     */
    TheTableMaker(Class<?> type, RowGen rowGen, RowGen codecGen, byte[] secondaryDesc,
                  boolean supportsIndexLock, RowStore store, long tableId)
    {
    ...
    private void addDynamicEncodeValueColumns() {
        ...
        var indy = mm.var(TheTableMaker.class).indy
    ...
    private void addDynamicDecodeValueColumns() {
        // First define a method which generates the SwitchCallSite.
        {
            ...
            var condy = mm.var(TheTableMaker.class).condy
        ...
        var indy = mm.var(TheTableMaker.class).indy("indyDecodeValueColumns");
    ...
    private void addUnfilteredMethods() {
        ...
        var condyClass = mm.var(TheTableMaker.class).condy
        ...
        throws Throwable
    {
        ...
        ClassMaker cm = RowGen.beginClassMaker(TheTableMaker.class, rowType, rowInfo, null, name)
