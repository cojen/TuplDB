 ...
 */
final class DifferenceView extends MergeView {
    DifferenceView(Combiner combiner, View first, View second) {
    ...
    {
        return new DifferenceCursor(view, comparator, first, second);
    }
