 ...
 * 
 *
 * @author Generated by PageAccessTransformer from Checkpointer.java
 */
/*P*/
final class _Checkpointer implements Runnable {
    ...
    private final ReferenceQueue<_LocalDatabase> mRefQueue;
    ...
    _Checkpointer(_LocalDatabase db, DatabaseConfig config) {
    ...
    static class Hook extends Thread {
        private final _Checkpointer mCheckpointer;

        Hook(_Checkpointer c) {
            mCheckpointer = c;
        }
