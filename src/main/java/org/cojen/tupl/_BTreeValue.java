...
final class _BTreeValue {
            ...
            nonFrag: {
                ...
                decodeLen: if (vHeader >= 0) {
                    ...
                    if ((vHeader & 0x20) == 0) {
                        ...
                        if (b == TOUCH_VALUE) {
                            // This case isn't expected, because _BTreeCursor.compact doesn't
                            // call this method for non-fragmented values.
                            return 0;
                        }
            ...
            case OP_WRITE:
                ...
                if (endPos <= fLen) {
                    ...
                    if (b == TOUCH_VALUE) {
                        ...
                        // This case isn't expected, because _BTreeCursor.compact holds the node
                    ...
                    if ((fHeader & 0x01) != 0) try {
                        ...
                        if (db.levelCap(levels) < newLen) {
                            ...
                            _Node[] newNodes = new _Node[newLevels - levels];
     ...
     */
    private static int tryIncreaseLengthField(final _BTreeCursor cursor, final _CursorFrame frame,
        ...
        throws IOException
    {
        ...
        final _Node[] fNodes = new _Node[(endLoc - startLoc) / 6];
        final int pageSize = pageSize(db, page);
