 ...
 * 
 *
 * @author Generated by PageAccessTransformer from PrepareWriter.java
 */
/*P*/
final class _PrepareWriter extends _HandlerWriter<PrepareHandler> implements PrepareHandler {
    _PrepareWriter(_LocalDatabase db, int handlerId, PrepareHandler recoveryHandler) {
    ...
    private void prepare(Transaction txn, byte[] message, boolean commit) throws IOException {
        if (txn instanceof _LocalTransaction local && local.mDatabase == mDatabase) {
