...
/**
 * Used by {@link _ReplWriter} to queue up transactions which commit asynchronously.
 *
 * @author Generated by PageAccessTransformer from PendingTxnWaiter.java
 */
/*P*/
final class _PendingTxnWaiter extends Thread {
    private static final int TIMEOUT_MILLIS = 60000;

    static final int PENDING = 1, DO_COMMIT = 2, DO_ROLLBACK = 3, EXITED = 4;

    private final _ReplWriter mWriter;
    ...
    _PendingTxnWaiter(_ReplWriter writer) {
        mFlipPos = -1;
        mWriter = writer;
    }
