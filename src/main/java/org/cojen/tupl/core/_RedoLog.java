...
import static org.cojen.tupl.core._LocalDatabase.REDO_FILE_SUFFIX;
...
final class _RedoLog extends _RedoWriter {
     ...
     */
    _RedoLog(Crypto crypto, File baseFile, long logId, long redoPos, _TransactionContext context)
        throws IOException
    {
        mCrypto = crypto;
        mBaseFile = baseFile;
