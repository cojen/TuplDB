...
final class _UndoLog implements _DatabaseAccess {
    ...
    */
    ...
    static {
        try {
            cCommittedHandle =
                MethodHandles.lookup().findVarHandle(_UndoLog.class, "mCommitted", int.class);
        } catch (Throwable e) {
    ...
    /**
     * Called by _LocalTransaction, from the thread which currently owns the transaction.
     */
    void uncommit() {
