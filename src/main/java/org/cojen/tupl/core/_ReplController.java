...
final class _ReplController extends _ReplWriter {
    ...
    static {
        try {
            ...
            cSwitchingHandle = lookup.findVarHandle
                (_ReplController.class, "mSwitchingToReplica", boolean.class);
        } catch (Throwable e) {
    ...
    private void doSwitchToReplica(_ReplWriter redo) {
        ...
        try {
            ...
            // transferred to _ReplEngine and can be acted upon as replicas.
            ...
            // writer is closed, and then _LocalDatabase.cleanupMasterUndoLog is called. If
        ...
        // Use this _ReplController instance for replica mode. Can only be assigned after engine
