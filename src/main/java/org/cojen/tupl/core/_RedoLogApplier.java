 ...
 */
/*P*/
final class _RedoLogApplier extends _ReplEngine implements ReplicationManager {
    ...
    // ReplicationManager instance to the _ReplEngine. It would instead need to have checks
