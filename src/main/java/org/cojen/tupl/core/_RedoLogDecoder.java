...
/**
 * Log operations written by {@link _RedoLog} encode a special terminator, as a crude way to
 * detect if the log was truncated. This class decodes and verifies the terminators.
 *
 * @author Generated by PageAccessTransformer from RedoLogDecoder.java
 */
/*P*/
final class _RedoLogDecoder extends RedoDecoder {
