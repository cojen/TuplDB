 ...
 * 
 *
 * @author Generated by PageAccessTransformer from PendingTxnFinisher.java
 */
/*P*/
final class _PendingTxnFinisher extends Latch implements Runnable {
    private final int mMaxThreads;
    private final Latch.Condition mIdleCondition;

    private _PendingTxn mFirst, mLast;
