...
class _Locker extends _LockOwner {
    ...
    /**
     * Transfers all exclusive locks held by this _Locker and releases all others. Assumes that
    ...
    /**
     * Assigns all owned locks to be this _Locker. Is used when transferring ownership of
     * prepared transactions.
     */
    final void takeLockOwnership() {
        Object tailObj = mTailBlock;
        if (tailObj instanceof _Lock) {
            mManager.takeLockOwnership((_Lock) tailObj, this);
    ...
    static final class Block {
         ...
         */
        int unlockNonExclusive(_Locker locker) {
        ...
        void takeLockOwnership(_Locker locker) {
            _LockManager manager = locker.mManager;
