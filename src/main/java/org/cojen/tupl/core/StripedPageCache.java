 ...
 */
public final class StripedPageCache implements PageCache {
     ...
     */
    public StripedPageCache(long capacity, int pageSize) {
     ...
     * @param capacity capacity in bytes
     */
    public StripedPageCache(long capacity, final int pageSize, int minStripes) {
