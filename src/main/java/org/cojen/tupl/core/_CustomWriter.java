 ...
 * 
 *
 * @author Generated by PageAccessTransformer from CustomWriter.java
 */
/*P*/
final class _CustomWriter extends _HandlerWriter<CustomHandler> implements CustomHandler {
    _CustomWriter(_LocalDatabase db, int handlerId, CustomHandler recoveryHandler) {
