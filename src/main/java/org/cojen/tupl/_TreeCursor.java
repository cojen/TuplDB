 ...
 */
class _TreeCursor extends AbstractCursor {
    ...
    */
     ...
     */
    final void appendTransfer(_Node snode) throws IOException {
        try {
    ...
    final void appendTransfer(AbstractCursor source) throws IOException {
        _TreeCursor scursor = (_TreeCursor) source;
        ...
        try {
            ...
            _CursorFrame sleaf = scursor.mLeaf;
            ...
            scursor.next(_LocalTransaction.BOGUS, sleaf);
        } catch (Throwable e) {
            throw handleException(e, false);
        } finally {
            commitLock.unlock();
