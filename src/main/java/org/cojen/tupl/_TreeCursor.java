...
class _TreeCursor implements CauseCloseable, Cursor {
    ...
    */
        ...
        start: while (true) {
            ...
            search: while (true) {
                ...
                if (node.isLeaf()) {
                    ...
                    // _Node is not a leaf, but its kids are all leaves
                    ...
                    if (child != null) { // node is cached.  Otherwise, we go down to latchchild block.
                        ...
                        try {
                            int spos = (lowKey == null) ? 0 : _Node.internalPos(node.binarySearch(lowKey));
                    ...
                    if (child != null) { 
                        ...
                        try {
                            ...
                            //   then the isBottomInternal check won't see a "lock" _Node instance, which never
     ...
     */
    private LockResult doLoad(_LocalTransaction txn) throws IOException {
        byte[] key = mKey;
        if (key == null) {
    ...
    final void trim() throws IOException {
        ...
        next(_LocalTransaction.BOGUS, leaf);
    }
     ...
     */
    private _Node trimNode(final _CursorFrame frame, final _Node node) throws IOException {
