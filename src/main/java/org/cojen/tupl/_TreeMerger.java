...
class _TreeMerger {
     ...
     * finishes.
     */
    static _Tree merge(ExecutorService executor, _LocalDatabase db, int threadCount, _Tree... sources)
        throws IOException
    {
        ...
        _Tree target = db.newTemporaryIndex();
        if (partitions != null) {
